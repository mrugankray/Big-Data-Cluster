...
export SPARK_MASTER=spark://namenode:7077                          # Spark master url. eg. spark://master_addr:7077. Leave empty if you want to use local mode.
# export ZEPPELIN_ADDR                          # Bind address (default 127.0.0.1)
export ZEPPELIN_PORT=8082                          # port number to listen (default 8080)
...
export PYSPARK_PYTHON=/root/anaconda/bin/python3.9                         # path to the python command. must be the same path on the driver(Zeppelin) and all workers.
export PYTHONPATH=/root/anaconda/bin/python3.9
